defmodule Cs491Hm2.Company do
  ...
  def list_departments do
    Repo.all(Department) |> Repo.preload(:employee)
  end
  ...
  """
  def list_roles do
    Repo.all(Role) |> Repo.preload(:employee)
  end
  ...
  def list_employees do
    Repo.all(Employee) |> Repo.preload(:role) |> Repo.preload(:department)
  end
  ...
  """
  def get_employee!(id), do: Repo.get!(Employee, id) |> Repo.preload(:role) |> Repo.preload(:department)
  ...
  #def roleNumber do
  #  query = from r in Role, left_join: emp in assoc(r, :employee), select: count()
  #  Repo.all(query)
  #end
